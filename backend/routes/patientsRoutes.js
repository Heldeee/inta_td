...
import { getPatientInfo, getAllPatients, createPatient, getPatientsByDoctor, getPatientByKeycloakId, sendPatientToFhir } from '../controllers/patientsController.js';
...
router.post('/fhir', sendPatientToFhir); // Send patient data to FHIR server
